...
!!-----------------------------------------------------------------------------------------------------------------
!!
subroutine WriteOutNetcdf_mp(iht,OutFileName,rmout,mout,qq,env,conf,lout,mpl,aero,arscl,mwr,spectra,status) !arscl&mwr are added by oue 2017.03.23, added spectra by oue in May 2018
Use netcdf
Use crsim_mod
...
integer  :: elevID,azimID,rangeID,ZminID
...
!
!
subroutine WriteOutNetcdf_rmp(iht,OutFileName,rmout,qq,env,conf,lout,mpl,aero,arscl,mwr,spectra,status) !arscl&mwr are added by oue 2017.03.23, added spectra by oue in May 2018
Use netcdf
Use crsim_mod
Use postprocess_mod !added by oue 2017.03.23
Implicit None
